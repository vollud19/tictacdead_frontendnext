    ...
    return (
        <div className='text-white'>
            <div className='max-w-[1100px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
                ...
                <h1 className="font-redundead md:text-8xl sm:text-6xl text-4xl font-bold md:py-6">TicTac<span className='text-red-950'>Dead</span></h1>
                ...
                <p className="md:text-2xl text-xl font-bold text-gray-500">A hardcore version of the most famous game TicTacToe. A strategie game for people who need the next challenge for their mind.</p>
                <div className='rounded-md font-medium my-6 mx-auto py-4'>
                    <button onClick={() => router.push('/playgame')} className={styles.button}>
                        PLAY NOW!
                        <span></span>
                        <span></span>
                        <span></span>
