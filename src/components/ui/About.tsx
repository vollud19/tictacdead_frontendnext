...
import lucasImg from '../ui/LucasImg.png'

// Component of the website to display the people who worked on the website / game, with their roles
function About() {
    return (
        <div id="about" className='w-full h-screen py-[3rem] px-4 bg-black'>
            ...
            <div className='max-w-[1200px] mx-auto grid md:grid-cols-3 gap-7'>
                <div
                    ...
                    <img className='w-20 mx-auto mt-[-3rem] bg-white rounded-md' src="design-thinking.png"/>
                ...
                <div
                    ...
                    <img className='w-20 mx-auto mt-[-3rem] bg-white rounded-md' src="design-thinking.png"/>
                    <h3 className='text-4xl font-bold text-center py-4 text-[#000000]'>Franz Koinegg</h3>
